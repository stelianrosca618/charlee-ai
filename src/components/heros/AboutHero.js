        ...
        <Container maxWidth="lg" className="h-full">
          <Box className="w-full h-full" display={"flex"} justifyContent={"center"} alignItems={"center"} >
            <div>
              ...
              <h2 className="text-white text-[65px] leading-[71.5px] font-medium mt-6">
      ...
      <Box className="w-full bg-[#4CFFE9] relative">
        <Container maxWidth="lg">
          <Box className="w-full">
            <Grid2 container >
              <Grid2 size={7}>
                <Box className="w-full text-left pt-[110px] pb-[190px]">
              ...
              <Grid2 size={5} className="relative">
                <Box className="w-full relative">
                  <img src={handPhone} alt="handPhone" className="w-full h-full hidden"/>
        ...
        <img src={handPhone} alt="alt-handphone" className="absolute h-[120%] bottom-0 right-0" />
      </Box>
    </>
